...
router.post("/", restrictTo("doctor", "admin", "front_desk", "super_admin"), consultationController.recordConsultation);
router.get("/pending", restrictTo("doctor", "admin", "super_admin"), consultationController.getPendingConsultations);
router.put("/:id", restrictTo("doctor", "admin", "super_admin"), consultationController.updateConsultation);
